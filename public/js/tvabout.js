...
fetch(
        `${tv_detail_http}${movie_id}/credits?` +
        new URLSearchParams({
            api_key: api_key,
            language: "es",
        })
...
console.log(`${tv_detail_http}${movie_id}/videos?${api_key}`);
fetch(
        `${tv_detail_http}${movie_id}/videos?` +
        new URLSearchParams({
            api_key: api_key,
            language: "es",
        })
...
fetch(
        `${tv_detail_http}${movie_id}/recommendations?` +
        new URLSearchParams({
            api_key: api_key,
            language: "es",
        })
